...
public class Tuesday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int v = this.getArguments().getInt("11");
        int v1 = this.getArguments().getInt("22");
        int v2 = this.getArguments().getInt("33");
        int v3 = this.getArguments().getInt("44");
        int v4 = this.getArguments().getInt("55");
        int v5 = this.getArguments().getInt("66");
        vi= inflater.inflate(R.layout.fragment_tuesday,container,false);
        r=v2-2;
        m=(r*60+v3);
        if(m>420)
        {
