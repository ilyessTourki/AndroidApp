...
public class Monday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int v = this.getArguments().getInt("1");
        int v1 = this.getArguments().getInt("2");
        int v2 = this.getArguments().getInt("3");
        int v3 = this.getArguments().getInt("4");
        int v4 = this.getArguments().getInt("5");
        int v5 = this.getArguments().getInt("6");
        vi = inflater.inflate(R.layout.fragment_monday,container,false);
        r=v2-2;
        m=(r*60+v3);
        if(m>420)
        {
