...
public class Friday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int v = this.getArguments().getInt("77");
        int v1 = this.getArguments().getInt("88");
        int v2 = this.getArguments().getInt("99");
        int v3 = this.getArguments().getInt("1010");
        int v4 = this.getArguments().getInt("1111");
        int v5 = this.getArguments().getInt("1212");
        vi = inflater.inflate(R.layout.fragment_friday,container,false);
        r=v2-2;
        m=(r*60+v3);
        if(m>420)
        {
