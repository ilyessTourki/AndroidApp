...
public class Wednesday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int v = this.getArguments().getInt("111");
        int v1 = this.getArguments().getInt("222");
        int v2 = this.getArguments().getInt("333");
        int v3 = this.getArguments().getInt("444");
        int v4 = this.getArguments().getInt("555");
        int v5 = this.getArguments().getInt("666");
        vi = inflater.inflate(R.layout.fragment_wednesday,container,false);
        r=v2-2;
        m=(r*60+v3);
        if(m>420)
        {
