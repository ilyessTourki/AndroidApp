...
public class Saturday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int v = this.getArguments().getInt("777");
        int v1 = this.getArguments().getInt("888");
        int v2 = this.getArguments().getInt("999");
        int v3 = this.getArguments().getInt("101010");
        int v4 = this.getArguments().getInt("111111");
        int v5 = this.getArguments().getInt("121212");
        vi = inflater.inflate(R.layout.fragment_saturday,container,false);
        r=v2-2;
        m=(r*60+v3);
        if(m>420)
        {
